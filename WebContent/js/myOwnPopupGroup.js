...
function loadPopupCover(){
	...
	if(popupStatus==0){
		...
		document.getElementById('uploadGroupPhoto').src = document.getElementById('uploadGroupPhoto').src;
		document.getElementById("uploadGroupPhoto").contentDocument.location.reload(true);
...
function loadPopup(groupId){
	...
	if(popupStatusCover==0){
		...
		//var fra=document.getElementById("myIFrameUpload").src="photoUpload.jsp";
		var url="photoUploadGroupCoverPage.jsp?groupId="+groupId;
				
		document.getElementById('uploadGroupPhoto').src =url;
		//document.getElementById("uploadGroupPhoto").contentDocument.location.reload(true);
...
function callDivPopup(groupId){
	  ...
	  var url = "ManageCalSession?empid="+document.myFormCover.groupIdHidden.value;
	  try {
