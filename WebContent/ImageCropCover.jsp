...
<html>
	...
	String ext ="";
		String imagePath=empInfo.getCoverPath();//EmployeeInfo.getImagePath("",request);
		...
		if(imagePath!=null && !imagePath.equalsIgnoreCase("") && imagePath.length()>4){
			...
			imagePath=imagePath.replace("0_","1_");
	...
	%>
		...
		<script src="js/jquery.JcropCrop.js"></script>
 ...
 <table width="100%" cellpadding="0" cellspacing="0">
	...
	<div class="jcExample">
	<div class="article">
<form action="ImageCropCover" method="get"  onsubmit="return checkCoords();">
<input type="submit" value=" Crop Cover Image " class="Button"  style="z-index: 20;"/>
<br><br>
		<% if(isImagePathExistis){ %>
		<!-- This is the image we're attaching Jcrop to -->
		<img   src="<%=PropertyReader.getValue("photoAlbumPath",request) %><%=imagePath %>" id="cropbox" />
	 ...
	 */
		var h=0;//$("#cropbox").width();
	 	var w=0;//$("#cropbox").height();
