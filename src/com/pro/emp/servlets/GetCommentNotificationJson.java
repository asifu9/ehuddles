 ...
 */
@WebServlet("/GetCommentNotificationJson")
public class GetCommentNotificationJson extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetCommentNotificationJson() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<CommentNotificationJson> p= CommentNotificationsDAO.getCommentNotifications( id);
